...
//					tvLoading.setVisibility(View.GONE);
				...
				if (noNetworkMessage == null) {
					noNetworkMessage = getContext().getString(R.string.network_error);
				}

				if (noInternetMessage == null) {
					noInternetMessage = getContext().getString(R.string.no_internet);
				}

				if (unknownResponseMessage == null) {
					unknownResponseMessage = getContext().getString(R.string.unknown_response);
				}
	...
	public void showLoadingV3() {
		this.clearAnimation();
		this.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.dark_gray));
