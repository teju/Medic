...
import com.moguls.medic.model.getProfile.GetProfile;
...
public class GetProfilePatientViewModel extends BaseViewModel {
    ...
    public GetProfile getProfile = null;

    public GetProfilePatientViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String patientid) {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            getProfile = gson.fromJson(response.getContent().toString(), GetProfile.class);
                            if (getProfile.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.getPatientProfile+"/"+patientid);
