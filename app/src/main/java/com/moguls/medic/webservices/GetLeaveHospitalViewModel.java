...
public class GetLeaveHospitalViewModel extends BaseViewModel {
    ...
    public GetLeaveHospitalViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String hospitalID) {
        ...
        genericHttpAsyncTask.setUrl(APIs.leavehospital+"/"+hospitalID);
