...
public class GetHospitalViewModel extends BaseViewModel {
    ...
    public GetHospitalViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String hospitalID) {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            hospital = gson.fromJson(response.getContent().toString(), Hospital.class);
                            if (hospital.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.gethospital+"/"+hospitalID);
