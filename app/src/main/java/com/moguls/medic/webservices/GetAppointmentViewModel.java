...
import com.moguls.medic.model.getAppointment.GetAppointment;
...
public class GetAppointmentViewModel extends BaseViewModel {
    ...
    public GetAppointment getAppointment = null;

    public GetAppointmentViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String appointmentID) {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            getAppointment = gson.fromJson(response.getContent().toString(), GetAppointment.class);
                            if (getAppointment.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.getappointment+"/"+appointmentID);
