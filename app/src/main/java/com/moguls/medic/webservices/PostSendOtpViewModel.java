...
public class PostSendOtpViewModel extends BaseViewModel {
    ...
    public PostSendOtpViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String mobile_number) {
        ...
        genericHttpAsyncTask.setUrl(APIs.sendOtp+"/"+mobile_number);
