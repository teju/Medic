...
public class GetMyChatListViewModel extends BaseViewModel {
    ...
    public MyChat myChat = null;

    public GetMyChatListViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData() {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            myChat = gson.fromJson(response.getContent().toString(), MyChat.class);
                            if (myChat.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.getmychats);
