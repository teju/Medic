...
import com.moguls.medic.model.doctorAppointments.GetAppointmentSlots;
...
public class PostGetDoctorAppointmentsSlotsViewModel extends BaseViewModel {
    ...
    public com.moguls.medic.model.doctorAppointments.GetAppointmentSlots getAppointmentSlots = null;

    public PostGetDoctorAppointmentsSlotsViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
