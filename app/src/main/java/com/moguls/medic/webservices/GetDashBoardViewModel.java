...
public class GetDashBoardViewModel extends BaseViewModel {
    ...
    public GetDashBoardViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            dashBoard = gson.fromJson(response.getContent().toString(), DashBoard.class);
                            if (dashBoard.getStatus().equals(BaseKeys.STATUS_CODE)) {
