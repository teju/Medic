...
public class GeAppointmentsViewModel extends BaseViewModel {
    ...
    public GeAppointmentsViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData() {
        ...
        genericHttpAsyncTask.setUrl(APIs.getuserappointments);
