...
import com.moguls.medic.model.hospitalSummary.HospitalSummary;
...
public class GetHospitalSymmaryViewModel extends BaseViewModel {
    ...
    public HospitalSummary hospitalSummary = null;

    public GetHospitalSymmaryViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String hospitalID) {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            hospitalSummary = gson.fromJson(response.getContent().toString(), HospitalSummary.class);
                            if (hospitalSummary.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.gethospitalsummary+"/"+hospitalID);
