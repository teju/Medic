...
public class PostAddDoctorViewModel extends BaseViewModel {
    ...
    public PostAddDoctorViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String doctorid,String hospitalid) {
        ...
        genericHttpAsyncTask.setUrl(APIs.adddoctor+"/"+doctorid+"/"+hospitalid);
