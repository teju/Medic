...
public class PostConfirmAppointmentViewModel extends BaseViewModel {
    ...
    public PostConfirmAppointmentViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String ID,String HospitalID,String AppointmentOn,String Remarks,String PatientID) {
        ...
        genericHttpAsyncTask.setUrl(APIs.confirmappointment);
        ...
        genericHttpAsyncTask.setPostParams(BaseKeys.Remarks,Remarks);
        genericHttpAsyncTask.setPostParams(BaseKeys.PatientID,PatientID);
