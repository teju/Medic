...
import com.moguls.medic.model.doctorProfileDetails.DoctorsProfileDetails;
...
public class GeDoctorProdileDetailsViewModel extends BaseViewModel {
    ...
    public DoctorsProfileDetails getdDoctorsProfileDetails = null;

    public GeDoctorProdileDetailsViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData() {
            ...
            public void onPostExecute(Response response) {
                {
                    ...
                    if (json != null) {
                        try {
                            ...
                            getdDoctorsProfileDetails = gson.fromJson(response.getContent().toString(), DoctorsProfileDetails.class);
                            if (getdDoctorsProfileDetails.getStatus().equals(BaseKeys.STATUS_CODE)) {
        ...
        genericHttpAsyncTask.setUrl(APIs.getdoctorprofileinit);
