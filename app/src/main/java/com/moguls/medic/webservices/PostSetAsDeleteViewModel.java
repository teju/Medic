...
public class PostSetAsDeleteViewModel extends BaseViewModel {
    ...
    public PostSetAsDeleteViewModel(@NonNull Application application) {
        super(application);
        apl = application;
    }
    ...
    public void loadData(String ToUserID,String MessageID) {
        ...
        genericHttpAsyncTask.setUrl(APIs.setasdelete+"/"+ToUserID+"/"+MessageID);
